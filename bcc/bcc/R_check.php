  ...
  border-top-right-radius: 30px; height: 1000px; margin-top: 10px; background-color: #FFFFFF;">
      ...
      echo $row_3['pname'].' 교수님'; //들어온 교수번호로 교수이름 출력
       ?>
        ...
        <thead>
          <tr>
            <th>학번</th> <th>1주차</th> <th>2주차</th> <th>3주차</th> <th>4주차</th> <th>5주차</th> <th>6주차</th> <th>7주차</th> <th>8주차</th>
          ...
          <tbody>
            <?php
              ...
              while( $row_4 = mysqli_fetch_array( $result_4 ) ) {
                echo '<tr><td>' . $row_4[ 'sid' ] .'</td><td>'. $row_4[ 'w01' ] .'</td><td>'. $row_4[ 'w02' ] .'</td><td>'. $row_4[ 'w03' ] .'</td><td>'.  $row_4[ 'w04' ] .'</td><td>'. $row_4[ 'w05' ]
      ...
      <article class="action_main_body_button">
        <a href = "http://bcc.iptime.org/bcc/S_check.php"><img src="image/button_2.png" width="100" height="27" alt=""/></a>
      </article>
		</section>
	</main>
</body>
